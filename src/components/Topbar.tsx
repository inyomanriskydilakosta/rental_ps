...
import { UserCircle2, ChevronDown, Bell } from 'lucide-react';
...
export default function Topbar() {
  ...
  return (
    <header className="fixed top-0 left-52 right-0 h-16 bg-white border-b border-gray-100 z-20 shadow-sm">
      <div className="flex items-center h-full px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Admin Profile */}
          <button className="flex items-center gap-2.5 pl-1 pr-2 py-1.5 rounded-xl hover:bg-gray-50 transition-colors group">
